  ...
  return (
    <div className="buscar-container">
      <h2 className="buscar-titulo">
        Pesquisa: <span className="buscar-query">"{query}"</span>
      </h2>
      {livros.length > 0 ? (
        <div className="livros-grid">
          {livros.map((livro) => {
            ...
            return (
              ...
              >
                {imgSrc ? (
                  <img src={imgSrc} alt={livro.titulo} />
                ) : (
                  <div className="livro-sem-capa">Sem capa</div>
                )}

                <p className="livro-titulo">
                  ...
                  {estrelas.map((item, index) => {
                    const estrela =
                      livro.avaliacao == null
                        ...
                        : item <= livro.avaliacao
                          ? <Star key={item} size={12} fill="gold" />
                          : <Star key={item} size={12} color="#b3b3b3" />;
